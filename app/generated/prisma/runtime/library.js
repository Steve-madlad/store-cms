  ...
  function ks(e) {
    ...
    if (e && e.path && e.path.length > 0)
      if (Array.isArray(e.path))
        for (let t of e.path)
          Li.existsSync(t) && (r = t.endsWith(".vault") ? t : `${t}.vault`);
...
var Vo = {
  enabled:
    !Mo && $o == null && qo !== "dumb" && ((si != null && si !== "0") || jo),
};
function F(e, r) {
...
var Be = (e) =>
  ...
  be = (e) =>
    Object.assign(pe(e), {
      between: (r, t) =>
        be(q(e, ((n, i) => I((o) => ye(o) && n <= o && i >= o))(r, t))),
  ...
  Ue = (e) =>
    Object.assign(pe(e), {
      between: (r, t) =>
        Ue(q(e, ((n, i) => I((o) => Ve(o) && n <= o && i >= o))(r, t))),
...
var mi = class e {
  ...
  when(r, t) {
    ...
    return new e(
      this.input,
      n ? { matched: !0, value: t(this.input, this.input) } : di,
    );
  }
  otherwise(r) {
  ...
  toString() {
    let { config: r } = this,
      t = r.provider.fromEnvVar
        ...
        : r.provider.value,
      n = JSON.parse(
        JSON.stringify({ provider: t, binaryTargets: Yc(r.binaryTargets) }),
      );
...
function Ys(e) {
  ...
  function i(o) {
    ...
    if (l === "bigint")
      return (o < 0 ? ((o = -o), (u.s = -1)) : (u.s = 1), pn(u, o.toString()));
    throw Error(He + o);
  }
  if (
    ((i.prototype = m),
...
var hd = (e) => e,
  ...
  v = {
    ...
    util: {
      ...
      objId: function (e) {
        return (
          e.__id || Object.defineProperty(e, "__id", { value: ++yd }),
          e.__id
        );
      },
...
function cm(e) {
  return {
    datamodel: { models: eo(e.models), enums: eo(e.enums), types: eo(e.types) },
  };
}
function eo(e) {
...
async function yl(e, r) {
  ...
  if (
    (tf("enginePath", n), n !== void 0 && e === "binary" && Si(n), n !== void 0)
  )
...
var Jn = (e, r = new mo()) => {
    ...
    return (
      e.getConnectionInfo &&
        (t.getConnectionInfo = af(r, e.getConnectionInfo.bind(e))),
      t
    );
  },
  sf = (e, r) => ({
...
var Ct = class extends $ {
  ...
  logs;
  constructor(r, t) {
    (super("Engine not started: healthcheck timeout", C(r, !0)),
      (this.logs = t));
  }
};
  ...
  class r {
    ...
    _request(n) {
      ...
      return this._tracingHelper.runInChildSpan(s.operation, () =>
        new gu.AsyncResource("prisma-client-request").runInAsyncScope(() =>
          l(o),
        ),
      );
    }
