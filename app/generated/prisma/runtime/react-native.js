...
S.toNearest = function (e, t) {
  ...
  return (
    e.d[0]
      ? ((_ = !1), (r = $(r, e, 0, t, 1).times(e)), (_ = !0), I(r))
      : ((e.s = r.s), (r = e)),
    r
  );
};
...
function ku(e) {
  var t,
    ...
    a = [];
  if (
    (e === void 0 ? (e = this.precision) : se(e, 1, Be),
    (n = Math.ceil(e / F)),
    this.crypto)
  )
...
var Vu = (e) => e,
  ...
  D = {
    ...
    util: {
      ...
      objId: function (e) {
        return (
          e.__id || Object.defineProperty(e, "__id", { value: ++Qu }),
          e.__id
        );
      },
...
${a.backtrace}`,
  ...
  buildQueryError(t, r) {
    ...
    return n
      ? n.error
      : $r(t, this.config.clientVersion, this.config.activeProvider);
  }
