    ...
    if ((t && typeof t == "object") || typeof t == "function")
      for (let i of cu(t))
        !pu.call(e, i) &&
          ...
          Wr(e, i, {
            get: () => t[i],
            enumerable: !(n = lu(t, i)) || n.enumerable,
          });
    return e;
  };
var Ae = (e, t, r) => (
...
function jo(e, t) {
  ...
  for (
    t == null ? ((G = !1), (a = A)) : (a = t), s = new v(0.03125);
    e.abs().gte(0.1);
...
function Qt(e, t) {
  ...
  for (
    a = s = C = Me(C.minus(ge), C.plus(ge), w), v = V(C.times(C), w), i = 3;
    ;
          ...
          : a > 5 ||
            (a == 5 &&
              (r == 4 ||
                f ||
                (r == 6 &&
                  (n > 0 ? (i > 0 ? w / Ke(10, s - i) : 0) : A[v - 1]) % 10 &
                    1) ||
                r == (e.s < 0 ? 8 : 7))))),
    t < 1 || !A[0])
  )
...
function Qo(e, t) {
  var r,
    ...
    C = R.precision;
  if (!e.s || !t.s)
    return (t.s ? (t.s = -t.s) : (t = new R(e)), G ? V(t, C) : t);
  if (
    ((f = e.d),
    (A = t.d),
    (n = t.e),
...
var pt,
  ...
  Go = fe(() => {
    ...
    S.precision = S.sd = function (e) {
      ...
      if (
        ((t = Z(i) + 1), (n = i.d.length - 1), (r = n * j + 1), (n = i.d[n]), n)
      ) {
        for (; n % 10 == 0; n /= 10) r--;
  ...
  Wu.exports = {
    ...
    dependencies: {
      ...
      "@prisma/prisma-schema-wasm":
        "6.12.0-15.8047c96bbd92db98a2abc7c9323ce77c02c89dbc",
...
var kl = oe((N) => {
  ...
  var Jm = Array.from({ length: 256 }, (e, t) =>
  ...
  function id(e = 32) {
    ...
    if (Ot.crypto && typeof Ot.crypto.randomBytes == "function")
      return Ot.crypto.randomBytes(e);
...
var Fl = oe((H) => {
  ...
  var [ud, pd] = (0, br.split)(Ll, !0),
    Ol = (e, t, r) =>
      r > 32 ? (0, br.rotlBH)(e, t, r) : (0, br.rotlSH)(e, t, r),
    Dl = (e, t, r) =>
      r > 32 ? (0, br.rotlBL)(e, t, r) : (0, br.rotlSL)(e, t, r);
  function Nl(e, t = 24) {
...
var Tu = {
  enabled:
    !zo && Yo == null && Zo !== "dumb" && ((di != null && di !== "0") || Xo),
};
function q(e, t) {
...
function Cu(e) {
  let t = {
    ...
    r = (...n) => {
      ...
      if (
        (n.length !== 0 && Ht.push([o, ...n]),
        Ht.length > vu && Ht.shift(),
        Gt.enabled(o) || i)
      ) {
...
function zs(e, t, r) {
  ...
  return !t.result || !(t.result.$allModels || t.result[n])
    ...
    : Up({
        ...e,
        ...Ks(t.name, e, t.result.$allModels),
        ...Ks(t.name, e, t.result[n]),
      });
}
function Up(e) {
  let t = new Se(),
...
var Ea = (e) => (Array.isArray(e) ? e : e.split(".")),
  ...
  xa = (e, t, r) =>
    Ea(t).reduceRight(
      (n, i, o, s) => Object.assign({}, Ni(e, s.slice(0, o)), { [i]: n }),
      r,
    );
function im(e, t) {
...
\`\`\``
      : "",
    v = (0,
    $i.default)(`Hi Prisma Team! My Prisma Client just crashed. This is the report:
## Versions
...
function ji(e, t, r, n) {
  ...
  switch (r.type) {
    ...
    case "Time": {
      if (typeof e == "string")
        return { $type: "DateTime", value: `1970-01-01T${Ya(e)}` };
...
function Sd(e, t = Yl) {
  if (isNaN(e))
    throw new it(nt.EncodeTimeValueMalformed, `Time must be a number: ${e}`);
  if (e > Kl)
    throw new it(
      nt.EncodeTimeSizeExceeded,
      `Cannot encode a time larger than ${Kl}: ${e}`,
    );
  ...
  let r,
    n = "";
  for (let i = t; i > 0; i--)
    ((r = e % Tr), (n = zl.charAt(r) + n), (e = (e - r) / Tr));
  return n;
}
function Id() {
...
var $n = class {
    ...
    snapshot(t) {
      return Object.create(this.#e, {
        now: { value: t === "mysql" ? new lo() : new ao() },
      });
    }
    register(t, r) {
      this.#e[t] = r;
          ...
          case "parameterTupleList": {
            ...
            return w
              .map((A) => {
                ...
                let R = A.map((C) => (o.push(C), ho(t, i++))).join(
                  a.itemSeparator,
                );
  ...
  async interpretNode(t, r, n, i) {
    switch (t.type) {
      ...
      case "concat": {
        ...
        return {
          value: o.length > 0 ? o.reduce((s, a) => s.concat(vr(a)), []) : [],
        };
      }
      case "sum": {
        let o = await Promise.all(
      ...
      case "dataMap": {
        ...
        return {
          value: Za(o, t.args.structure, t.args.enums),
          lastInsertId: s,
        };
      }
      case "validate": {
      ...
      case "paginate": {
        ...
        if (f !== null) {
          ...
          return (
            ...
            {
              value: v.flatMap(([, A]) => uc(A, t.args.pagination)),
              lastInsertId: s,
            }
          );
        }
...
var Bd = 100,
  ...
  Sr = class {
    ...
    async closeTransaction(t, r) {
      (Rr("Closing transaction.", { transactionId: t.id, status: r }),
        (t.status = r));
      try {
...
var Jn = class e {
  ...
  async execute({
    ...
    let o = n
      ? this.#r.getTransaction(n, i !== void 0 ? "batch query" : "query")
      : this.#t;
...
var Po,
  hc = {
    async loadQueryCompiler(e) {
      ...
      if (r === void 0)
        throw new U("WASM query compiler was unexpectedly `undefined`", t);
      return (
        Po === void 0 &&
          (Po = (async () => {
...
${n.backtrace}`,
  ...
  async requestBatch(t, { transaction: r, customDataProxyFetch: n }) {
    ...
    try {
      ...
      return (
        r?.kind !== "itx" && (await this.transaction("commit", {}, w)),
        A
      );
    } catch (w) {
      throw this.#c(w, o);
...
async function qr(e, t) {
  ...
  if (n.type === "DataProxyError") {
    ...
    if ("InvalidRequestError" in n.body)
      throw new Ur(r, n.body.InvalidRequestError.reason);
  }
