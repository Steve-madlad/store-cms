    ...
    if ((t && typeof t == "object") || typeof t == "function")
      for (let i of Ta(t))
        !Aa.call(e, i) &&
          ...
          lr(e, i, {
            get: () => t[i],
            enumerable: !(n = va(t, i)) || n.enumerable,
          });
    return e;
  };
var Le = (e, t, r) => (
...
var Ri = Re((He) => {
  ...
  function _a(e) {
    ...
    if (e.length !== void 0)
      return typeof e.length != "number" || hn(e.length) ? xe(0) : pn(e);
  ...
  function za(e) {
    if (((e = e.split("=")[0]), (e = e.trim().replace(Ha, "")), e.length < 2))
      return "";
...
var tl = {
  enabled:
    !Oi && Di == null && Mi !== "dumb" && ((En != null && En !== "0") || _i),
};
function V(e, t) {
...
A.precision = A.sd = function (e) {
  ...
  return (
    r.d ? ((t = wo(r.d)), e && r.e + 1 > t && (t = r.e + 1)) : (t = NaN),
    t
  );
};
A.round = function () {
...
var $n = new WeakMap(),
  ...
  Vt = class {
    constructor(t, r) {
      ($n.set(this, { sql: t, values: r }),
        Object.defineProperty(this, Vr, { value: Vr }));
    }
    get sql() {
...
function dt(e = {}) {
  ...
  return Object.entries(t).reduce(
    (n, [i, o]) => (
      ls[i] !== void 0 ? (n.select[i] = { select: o }) : (n[i] = o),
      n
    ),
    { select: {} },
  );
