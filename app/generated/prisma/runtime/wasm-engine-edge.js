...
function hn(t, e) {
  ...
  for (
    e == null ? ((N = !1), (a = C)) : (a = e), s = new T(0.03125);
    t.abs().gte(0.1);
...
function dn(t, e) {
  ...
  if (((e = e.slice(n, i)), e)) {
    if (
      ...
      for (n && t.d.push(+e.slice(0, n)), i -= U; n < i; )
        t.d.push(+e.slice(n, (n += U)));
...
function bn(t, e) {
  var r,
    ...
    R = k.precision;
  if (!t.s || !e.s)
    return (e.s ? (e.s = -e.s) : (e = new k(t)), N ? _(e, R) : e);
  if (
    ((f = t.d),
    (C = e.d),
    (n = e.e),
...
var Fe,
  ...
  En = ne(() => {
    ...
    A.precision = A.sd = function (t) {
      ...
      if (
        ((e = $(i) + 1), (n = i.d.length - 1), (r = n * U + 1), (n = i.d[n]), n)
      ) {
        for (; n % 10 == 0; n /= 10) r--;
